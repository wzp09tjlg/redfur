...
public class MethodUtils {
    ...
    public static Method getMatchedMethod(Class<?> cls, String methodName, Class... parameterTypes)
        ...
        try {
            ...
            for (bestMatch = null; cls != null; cls = cls.getSuperclass()) {
                ...
                for (int var7 = 0; var7 < var6; ++var7) {
                    ...
                    if (method.getName().equals(methodName) && MemberUtils
                        ...
                        if (accessibleMethod != null && MemberUtils
                            .compareParameterTypes(accessibleMethod.getParameterTypes(), method.getParameterTypes(),
                                parameterTypes) < 0) {
